...
## Tasks
- [ ] Fix failing tests in vitest suite
  - [ ] Update snapshots matching new package version 0.5.45 in `tests/translator/golden-url-header.test.js` and `tests/translator/golden-request.test.js`
  ...
  - [ ] Fix logic in `tests/unit/translator-request-normalization.test.js` (array vs string content formatting)
  - [ ] Fix Cursor state database mock in `tests/unit/oauth-cursor-auto-import.test.js`
  - [ ] Fix time-out and assertion in `tests/unit/kiro-terminal-integrity.test.js` and `tests/unit/mimo-free.live.test.js`
